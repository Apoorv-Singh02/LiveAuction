 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Jr=S;function AI(t,e){return t===e&&(t!==0||1/t===1/e)||t!==t&&e!==e}var bI=typeof Object.is=="function"?Object.is:AI,DI=Jr.useState,LI=Jr.useEffect,MI=Jr.useLayoutEffect,FI=Jr.useDebugValue;function UI(t,e){var n=e(),r=DI({inst:{value:n,getSnapshot:e}}),i=r[0].inst,s=r[1];return MI(function(){i.value=n,i.getSnapshot=e,Cu(i)&&s({inst:i})},[t,n,e]),LI(function(){return Cu(i)&&s({inst:i}),t(function(){Cu(i)&&s({inst:i})})},[t]),FI(n),n}function Cu(t){var e=t.getSnapshot;t=t.value;try{var n=e();return!bI(t,n)}catch{return!0}}function jI(t,e){return e()}var $I=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?jI:UI;$_.useSyncExternalStore=Jr.useSyncExternalStore!==void 0?Jr.useSyncExternalStore:$I;j_.exports=$_;var zI=j_.exports,z_={exports:{}},W_={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C=function(t,e){if(!t)throw fi(e)},fi=function(t){return new Error("Firebase Database ("+J_.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jr(t,e){return Ks(t,"POST","/v1/accounts:signInWithIdp",mi(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function JR(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function ZR(t){ei(new rr("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:o,authDomain:l}=r.options;b(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const a={apiKey:o,authDomain:l,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Py(t)},u=new Tk(r,i,s,a);return Rk(u,n),u},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),ei(new rr("auth-internal",e=>{const n=vi(e.getProvider("auth").getImmediate());return(r=>new XR(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Sn(_m,ym,JR(t)),Sn(_m,ym,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class g0{constructor(e){this.allowedEvents_=e,this.listeners_={},C(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const r=[...this.listeners_[e]];for(let i=0;i<r.length;i++)r[i].callback.apply(r[i].context,n)}}on(e,n,r){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:r});const i=this.getInitialEvent(e);i&&n.apply(r,i)}off(e,n,r){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let s=0;s<i.length;s++)if(i[s].callback===n&&(!r||r===i[s].context)){i.splice(s,1);return}}validateEventType_(e){C(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Zc;function iN(t){Zc=t}const S0=function(t){return typeof t=="number"?"number:"+Jy(t):"string:"+t},C0=function(t){if(t.isLeafNode()){const e=t.val();C(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Gt(e,".sv"),"Priority must be a string or number.")}else C(t===Zc||t.isEmpty(),"priority of unexpected type.");C(t===Zc||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function k0(t){return{type:"value",snapshotNode:t}}function ni(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function As(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function bs(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function mN(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zf{constructor(e){this.index_=e}updateChild(e,n,r,i,s,o){C(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(n);return l.getChild(i).equals(r.getChild(i))&&l.isEmpty()===r.isEmpty()||(o!=null&&(r.isEmpty()?e.hasChild(n)?o.trackChildChange(As(n,l)):C(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?o.trackChildChange(ni(n,r)):o.trackChildChange(bs(n,r,l))),e.isLeafNode()&&r.isEmpty())?e:e.updateImmediateChild(n,r).withIndex(this.index_)}updateFullNode(e,n,r){return r!=null&&(e.isLeafNode()||e.forEachChild(se,(i,s)=>{n.hasChild(i)||r.trackChildChange(As(i,s))}),n.isLeafNode()||n.forEachChild(se,(i,s)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(s)||r.trackChildChange(bs(i,s,o))}else r.trackChildChange(ni(i,s))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?A.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dl{constructor(e,n,r){this.path=e,this.affectedTree=n,this.revert=r,this.type=pt.ACK_USER_WRITE,this.source=P0()}operationForChild(e){if(U(this.path)){if(this.affectedTree.value!=null)return C(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new K(e));return new Dl(W(),n,this.revert)}}else return C(M(this.path)===e,"operationForChild called for unrelated child."),new Dl(q(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ms{constructor(e,n,r){this.source=e,this.path=n,this.children=r,this.type=pt.MERGE}operationForChild(e){if(U(this.path)){const n=this.children.subtree(new K(e));return n.isEmpty()?null:n.value?new ar(this.source,W(),n.value):new Ms(this.source,W(),n)}else return C(M(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ms(this.source,q(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WN{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,r=e.childName;C(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),C(r!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(r);if(i){const s=i.type;if(n==="child_added"&&s==="child_removed")this.changeMap.set(r,bs(r,e.snapshotNode,i.snapshotNode));else if(n==="child_removed"&&s==="child_added")this.changeMap.delete(r);else if(n==="child_removed"&&s==="child_changed")this.changeMap.set(r,As(r,i.oldSnap));else if(n==="child_changed"&&s==="child_added")this.changeMap.set(r,ni(r,e.snapshotNode));else if(n==="child_changed"&&s==="child_changed")this.changeMap.set(r,bs(r,e.snapshotNode,i.oldSnap));else throw fi("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(r,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dO(t){oP(pi),ei(new rr("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return sO(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),Sn(Em,Sm,t),Sn(Em,Sm,"esm2017")}Mt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Mt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};dO();const fO={apiKey:"AIzaSyDVyRBVvubj2N3PxRA1UtUJekSEMPMPXns",authDomain:"liveauction-d1e9d.firebaseapp.com",projectId:"liveauction-d1e9d",storageBucket:"liveauction-d1e9d.appspot.com",messagingSenderId:"338387433812",appId:"1:338387433812:web:2b4f0848f9dd9e8177f0c1",measurementId:"G-JBH07604P6",databaseURL:"https://liveauction-d1e9d-default-rtdb.firebaseio.com"},dw=cy(fO),zl=rP(dw),gh=uO(dw);function hO(){const t=di(e=>e.user.user);return I.jsx("span",{className:"nav-span nav-log",onClick:()=>{t&&Hk(zl)},children:t?"Logout":"Login"})}function pO(){const t=Vs(),e=E1();return S.useEffect(()=>{Vk(zl,n=>{n?(e(RI(n)),e(NI(n.email)),t("/")):(e(PI()),t("/login"))})},[]),I.jsxs(I.Fragment,{children:[I.jsxs("div",{className:"nav",children:[I.jsxs("div",{className:"nav-left",children:[I.jsx("img",{src:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5xrFjseFrUChD7oOjdR9A9zrciLX_wkws7A&usqp=CAU",className:"nav-img"}),I.jsx("span",{className:"nav-span",children:"LiveAuction"}),I.jsx(Eo,{to:"/",children:I.jsx("span",{className:"nav-btn nav-span",children:"Home"})}),I.jsx(Eo,{to:"/DashBoard",children:I.jsx("span",{className:"nav-btn nav-span",children:"Dashboard"})}),I.jsx(Eo,{to:"/PostAd",children:I.jsx("span",{className:"nav-btn nav-span",children:"Post Ad"})})]}),I.jsx(Eo,{to:"/Login",children:I.jsx(hO,{})})]}),I.jsx(RC,{})]})}function mO(){const[t,e]=S.useState(""),[n,r]=S.useState(""),i=o=>{o.preventDefault(),zk(zl,t,n).then(l=>{console.log(l.user)}).catch(l=>{console.log(l)}),e(""),r("")},s=()=>{$k(zl,t,n).then(o=>{console.log(o.user)}).catch(o=>{console.log(o)}),e(""),r("")};return I.jsx("div",{className:"full-screen",children:I.jsxs("div",{className:"login-card",children:[I.jsx("h1",{style:{textAlign:"center"},children:"Login"}),I.jsxs("form",{onSubmit:i,children:[I.jsx("input",{value:t,type:"email",placeholder:"Email Address",className:"login-input",onChange:o=>{e(o.target.value)}}),I.jsx("input",{value:n,type:"password",placeholder:"Password",className:"login-input",onChange:o=>{r(o.target.value)}}),I.jsx("button",{type:"submit",className:"login-btn",children:"Sign In"})]}),I.jsxs("h3",{children:["New to this platform, ",I.jsx("span",{className:"login-span",onClick:s,children:"Sign Up"})]})]})})}function gO({onClose:t,index:e,image:n,title:r,price:i,Status:s,starttime:o,endtime:l,present:a,highest:u}){const[c,d]=S.useState(""),f=di(y=>y.user.userEmail);function p(y,m,h,v,w,T,k,R){console.log({num:h}),hh(fh(gh,"Products/"+R),{Title:y,Image:m,Price:h,Stats:v,Start:w,End:T,Highest:k}).then(N=>{console.log("run"),console.log(N)}).catch(N=>{console.log("Err"),console.log(N)})}const g=()=>{d(Number(c)),console.log(Number(c),Number(i),Number(c)>Number(i)),Number(c)>Number(i)&&p(r,n,Number(c),s,o,l,f,e),d(""),t()};function _(y){let m=(y/1e3).toFixed(0),h=(y/(1e3*60)).toFixed(0),v=(y/(1e3*60*60)).toFixed(0),w=(y/(1e3*60*60*24)).toFixed(0);return m<60?m+" Sec":h<60?h+" Min":v<24?v+" Hrs":w+" Days"}return I.jsx("div",{className:"modal",onClick:t,children:I.jsx("div",{className:"layout",children:I.jsxs("div",{className:"modal-card",onClick:y=>{y.stopPropagation()},children:[I.jsxs("h1",{style:{textAlign:"center",height:"20%"},children:[r,e]}),I.jsxs("div",{style:{display:"flex",width:"100%",height:"80%"},children:[I.jsx("div",{style:{display:"flex",width:"40%",height:"80%"},children:I.jsx("img",{src:n,style:{width:"433px",objectFit:"contain"}})}),I.jsxs("div",{style:{width:"60%",height:"80%",flexDirection:"column",justifyContent:"space-between"},children:[I.jsxs("div",{children:[I.jsxs("h2",{style:{marginBottom:"20px"},children:["Highest Bid : ",i]}),I.jsxs("h2",{style:{marginBottom:"20px"},children:["Time remaining : ",_(l-Date.now())," "]}),I.jsxs("h2",{style:{marginBottom:"20px"},children:["Highest Bidder : ",u]})]}),I.jsx("input",{type:"number",value:c,placeholder:"Enter your Bid",style:{height:"28px",marginTop:"20%",width:"50%"},onChange:y=>d(y.target.value)}),I.jsx("button",{className:"place",onClick:g,children:"Place Bid"})]})]})]})})})}function rg({index:t,image:e,title:n,price:r,Status:i,starttime:s,endtime:o,present:l,highest:a}){function u(f){let p=(f/1e3).toFixed(0),g=(f/(1e3*60)).toFixed(0),_=(f/(1e3*60*60)).toFixed(0),y=(f/(1e3*60*60*24)).toFixed(0);return p<60?p+" Sec":g<60?g+" Min":_<24?_+" Hrs":y+" Days"}const[c,d]=S.useState(!1);return I.jsxs("div",{className:"card",children:[c&&I.jsx(gO,{onClose:()=>{d(!1)},index:t,image:e,title:n,price:r,Status:i,starttime:s,endtime:o,present:l,highest:a}),I.jsx("div",{className:"card-img",children:I.jsx("img",{src:e,style:{width:"300px",height:"150px",borderRadius:"10%"}})}),I.jsx("div",{className:"card-title",children:n}),I.jsxs("span",{className:"card-price",children:["$",r]}),l&&I.jsxs("span",{className:"card-status",children:["Status: ",u(o-Date.now())," remaining"]}),!l&&I.jsxs("span",{className:"card-status",children:["Status: Starts in ",u(s-Date.now())]}),l&&I.jsx("button",{className:"place",onClick:()=>{d(!0)},children:"Place Bid"}),I.jsx("span",{children:t})]})}function vO(){const t=fh(gh,"Products"),[e,n]=S.useState([]),[r,i]=S.useState([]);return di(s=>s.user.user),S.useEffect(()=>{setInterval(()=>{tO(t,s=>{const o=[];s.forEach(l=>{o.push({id:l.key,value:l.val()})}),n(o.filter(l=>l.value.Start<=Date.now()&&l.value.End>=Date.now())),i(o.filter(l=>l.value.Start>Date.now()))})},1e3)},[]),I.jsxs("div",{className:"HomePage",children:[I.jsx("h1",{children:"On Going Auctions"}),I.jsx("div",{className:"grid-container",children:e.map(s=>I.jsx(rg,{index:s.id,image:s.value.Image,title:s.value.Title,price:s.value.Price,Status:s.value.Stats,endtime:s.value.End,starttime:s.value.Start,present:!0,highest:s.value.Highest}))}),e.length===0&&I.jsx("div",{style:{height:"300px",display:"block"}}),I.jsx("h1",{children:"Yet To Start"}),I.jsx("div",{className:"grid-container",children:r.map(s=>I.jsx(rg,{image:s.value.Image,title:s.value.Title,price:s.value.Price,Status:s.value.Stats,endtime:s.value.End,starttime:s.value.Start,present:!1}))})]})}function _O(){const t=Vs(),e=di(n=>n.user.user);return S.useEffect(()=>{e||t("/login")},[e]),I.jsx("div",{children:"DashBoard"})}function yO(){const[t,e]=S.useState(""),[n,r]=S.useState(""),[i,s]=S.useState(""),[o,l]=S.useState(""),[a,u]=S.useState(""),[c,d]=S.useState(""),f=Vs(),p=di(y=>y.user.user);S.useEffect(()=>{p||f("/login")},[p]);const g=y=>{y.preventDefault(),_(t,n,i,o,Date.parse(a),Date.parse(c),""),r(""),e(""),s(""),l(""),u(""),d("")},_=(y,m,h,v,w,T,k)=>{const R=fh(gh,"Products"),N=Zx(R);hh(N,{Title:y,Image:m,Price:h,Stats:v,Start:w,End:T,Highest:k})};return I.jsx("div",{className:"post-ad",children:I.jsx("div",{className:"post-card",children:I.jsxs("form",{onSubmit:g,children:[I.jsx("h2",{style:{textAlign:"center",margin:"20px 0px"},children:"Post An Ad"}),I.jsx("input",{value:t,type:"text",placeholder:"Name of the product",className:"post-input",onChange:y=>{e(y.target.value)}}),I.jsx("input",{value:n,type:"text",placeholder:"Image of the product",className:"post-input",onChange:y=>{r(y.target.value)}}),I.jsx("input",{value:i,type:"number",placeholder:"Base Price",className:"post-input",onChange:y=>{s(y.target.value)}}),I.jsx("input",{value:o,type:"text",placeholder:"Status",className:"post-input",onChange:y=>{l(y.target.value)}}),I.jsx("h3",{style:{fontWeight:"600",marginBottom:"5px"},children:"Start Time & date:"}),I.jsx("input",{type:"datetime-local",value:a,min:"2022-01-01T00:00",max:"2024-12-31T23:59",style:{height:"25px",width:"100%"},onChange:y=>{u(y.target.value)}}),I.jsx("h3",{style:{fontWeight:"600",marginTop:"15px",marginBottom:"5px"},children:"End Time & date:"}),I.jsx("input",{type:"datetime-local",value:c,min:"2022-01-01T00:00",max:"2024-12-31T23:59",style:{height:"25px",width:"100%"},onChange:y=>{d(y.target.value)}}),I.jsx("button",{type:"submit",className:"postad-btn",style:{width:"100%",backgroundColor:"blue",color:"white",fontWeight:"600",paddingTop:"15px",paddingBottom:"15px",marginTop:"35px"},children:"Post"})]})})})}function wO(){const t=di(n=>n.user.user),e=Vs();return I.jsxs(I.Fragment,{children:[I.jsx(pO,{}),I.jsxs(NC,{children:[I.jsx($i,{path:"/",index:!0,element:I.jsx(vO,{})}),I.jsx($i,{path:"/DashBoard",element:t?I.jsx(_O,{}):e("/Login")}),I.jsx($i,{path:"/PostAd",element:t?I.jsx(yO,{}):e("/Login")}),I.jsx($i,{path:"/Login",element:I.jsx(mO,{})})]})]})}$u.createRoot(document.getElementById("root")).render(I.jsx(DC,{children:I.jsx(_1,{store:OI,children:I.jsx(wO,{})})}));
